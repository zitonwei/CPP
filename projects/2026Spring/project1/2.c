...
//     strcpy(line, "-10.10");
//     BigDecimal tmp;
//     int flag = read_number(line, &tmp);
//     printf("len : %d, scale : %d, sign : %d\n", tmp.len, tmp.scale, tmp.sign);
//     write_number(tmp, line, sizeof(line));
//     printf("%s\n", line);
// }
...
//     BigDecimal tmp = subtract_numbers(left, right);
//     write_number(tmp, line, sizeof(line));
//     printf("%s\n", line);
// }
...
//     strcpy(line, "-123");
//     read_number(line, &right);
//     BigDecimal tmp = multiply_numbers(left, right);
//     write_number(tmp, line, sizeof(line));
//     printf("%s\n", line);
// }
...
//     read_number(line, &right);
//     BigDecimal tmp;
//     printf("ok ? : %d\n", divide_numbers(left, right, &tmp, 9));
//     write_number(tmp, line, sizeof(line));
//     printf("%s\n", line);
// }
